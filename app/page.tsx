    ...
    <div className="space-y-0">
      ...
      <section className="py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <Link
            ...
            className="inline-block border border-zinc-900 dark:border-white px-5 py-2 text-sm font-medium text-zinc-900 dark:text-white hover:bg-zinc-900 hover:text-white dark:hover:bg-white dark:hover:text-zinc-900 transition-colors"
          >
            {h.dsCta}
          </Link>
        </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative text-center max-w-2xl mx-auto">
          ...
          <Link
            href="/category/cs-basics"
            className="inline-block border border-white px-6 py-2.5 text-sm font-medium text-white hover:bg-white hover:text-zinc-900 transition-colors"
          >
            {h.csCta}
          </Link>
        </div>
